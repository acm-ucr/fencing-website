const What = () => {
  return (
      <div className="mb-12 flex h-screen w-full items-end gap-[7.5%] p-36">
        ...
        {/* <div> */}
        <div className="w-9/10 h-2/3 flex-1 overflow-hidden rounded-2xl bg-[grey]"></div>
        <div className="relative h-2/3 flex-[1.25] rounded-xl bg-[#054f8d]">
          <div className="absolute left-20 -translate-y-1/2 transform rounded-2xl border-4 border-[#0276d7] bg-[#082c4f] px-[8%] py-[3%] md:-translate-x-16 lg:-translate-x-32">
            <h3 className="text-3xl font-bold text-white">What we do!</h3>
          </div>
          <p className="m-16 text-2xl text-white">
