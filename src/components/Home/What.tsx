...
const What = () => {
  return (
    <div className="flex items-center justify-center">
      <div className="flex w-[90%] flex-col gap-16 px-20 lg:flex-row">
        <Image src={Photo} alt="What We Do" className="rounded-lg lg:w-1/2" />
        <div className="relative w-4/5">
          ...
          <p className="mt-5 h-3/4 w-48 rounded-lg bg-fencing-border-blue/40 p-10 text-2xl text-white md:w-auto lg:mt-10 lg:h-max">
